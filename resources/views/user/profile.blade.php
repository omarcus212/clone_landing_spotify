    ...
    <section class="w-screen min-h-screen bg-[#25CF60] flex justify-center items-center px-3 sm:px-4 md:px-6 py-6 md:py-0">
        ...
        <div
            ...
            <div class="flex flex-col md:flex-row flex-1 min-h-0">
                ...
                <!-- Formulário (esquerda) -->
                <form action=""
                    class="w-full md:w-1/2 relative h-auto md:h-full flex flex-col space-y-5 sm:space-y-6 md:space-y-7 p-4 sm:p-6 md:p-8 lg:p-10 overflow-y-auto scrollbar-visible scrollbar-thin scrollbar-thumb-[#1E1E1E] scrollbar-track-[#121212]">

                    <div
                        class="w-full px-4 sm:px-6 md:px-8 py-5 sm:py-6 md:py-8 border-b border-zinc-800/80 bg-gradient-to-b from-[#1E1E1E] to-[#121212]">
                        <div
                            class="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-8">
                            <div class="flex items-center gap-4 sm:gap-6">
                                <div class="relative">
                                    <div
                                        class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-[#25CF60] flex items-center justify-center shadow-lg shadow-[#25CF60]/30">
                                    ...
                                    <!-- Fundo degradê colorido (como na imagem que você mandou) -->
                                    <div
                                        class="absolute inset-0 rounded-full bg-gradient-to-br from-[#25CF60] via-[#1DB954] to-[#25CF60] opacity-30 blur-xl -z-10">
                                    </div>
                                </div>

                                <div>
                                    <h3 class="text-2xl sm:text-3xl font-bold text-white">Basic</h3>
                                    <p class="text-zinc-400 text-sm sm:text-base">Plano atual</p>
                                </div>
                            </div>

                            <!-- Lado direito: Status / Botão de upgrade -->
                            <div class="flex flex-col items-center sm:items-end gap-2 sm:gap-3">
                                <span
                    ...
                    <div class="w-full flex flex-col space-y-1.5 sm:space-y-2 md:space-y-3">
                        <span class="w-full flex justify-between items-center">
                            <label for="name" class="block text-sm sm:text-base font-medium text-zinc-400">Nome</label>
                            <button type="button"
                        ...
                        <input id="name" name="name" type="text" disabled required value="Marcus Vinnicius"
                        ...
                        @error('name') <p class="mt-1 text-xs sm:text-sm text-red-500">{{ $message }}</p> @enderror
                    </div>

                    <!-- Email -->
                    <div class="w-full flex flex-col space-y-1.5 sm:space-y-2 md:space-y-3">
                        <span class="w-full flex justify-between items-center">
                            <label for="email" class="block text-sm sm:text-base font-medium text-zinc-400">E-mail</label>
                            <button type="button"
                                class="p-1.5 sm:p-2 rounded-md bg-zinc-800 hover:bg-zinc-700 transition text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-[#1DB954]/50">
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <input id="email" name="email" type="email" disabled required value="marcus@gmail.com"
                            class="w-full h-10 sm:h-11 md:h-12 px-3 sm:px-4 bg-zinc-900 border border-zinc-700 rounded-md text-white placeholder-zinc-500 focus:border-[#1DB954] focus:ring-2 focus:ring-[#1DB954]/40 focus:outline-none transition text-sm sm:text-base" />
                        @error('email') <p class="mt-1 text-xs sm:text-sm text-red-500">{{ $message }}</p> @enderror
                    </div>

                    <!-- Senha -->
                    <div class="w-full flex flex-col space-y-1.5 sm:space-y-2 md:space-y-3">
                        <label for="password" class="block text-sm sm:text-base font-medium text-zinc-400">Senha</label>
                        <input id="password" disabled name="password" type="password" required autocomplete="new-password"
                            placeholder="************"
                ...
                <div
                    ...
                    <div class="px-4 sm:px-5 md:px-6 py-4 sm:py-5 border-b border-zinc-700">
                        <h3 class="text-lg sm:text-xl md:text-2xl font-semibold text-white">Em alta agora</h3>
                    </div>
