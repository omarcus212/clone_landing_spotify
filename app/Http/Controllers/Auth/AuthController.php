...
class AuthController
{
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        try {
            ...
            if (!config('services.mail_feature_enabled')) {
                ...
                return redirect()->route('login')->with('success', __('message.register_success'));
    ...
    public function sendResetLinkEmail(Request $request)
    {
        ...
        // Se a feature estiver desativada (Railway free)
        if (!config('services.mail_feature_enabled')) {
            return redirect()
                ->route('login')
                ->with('error', __('auth.email_feature_disabled'));
        }
